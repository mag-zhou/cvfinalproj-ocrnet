...
#SBATCH --mem=32G
#SBATCH -t 6:00:00
#SBATCH -o logs/train_mod3_50pct_%j.out
#SBATCH -e logs/train_mod3_50pct_%j.err
...
CONFIG="configs/ocrnet/boundary/ocrnet_r50_mod3_modulated_ocr_50pct.py"
WORK_DIR="work_dirs/ocrnet_r50_mod3_modulated_ocr_50pct"
