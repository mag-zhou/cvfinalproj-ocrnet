...
#SBATCH --mem=32G
#SBATCH -t 6:00:00
#SBATCH -o logs/train_mod2_50pct_%j.out
#SBATCH -e logs/train_mod2_50pct_%j.err
...
CONFIG="configs/ocrnet/boundary/ocrnet_r50_mod2_weighted_ce_50pct.py"
WORK_DIR="work_dirs/ocrnet_r50_mod2_weighted_ce_50pct"
