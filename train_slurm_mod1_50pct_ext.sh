...
#SBATCH --mem=32G
#SBATCH -t 6:00:00
#SBATCH -o logs/train_mod1_50pct_ext_%j.out
#SBATCH -e logs/train_mod1_50pct_ext_%j.err
...
CONFIG="configs/ocrnet/boundary/ocrnet_r50_mod1_aux_boundary_50pct_ext.py"
WORK_DIR="work_dirs/ocrnet_r50_mod1_aux_boundary_50pct_ext"
...
# from iter_40000.pth of the original Mod 1 run.
