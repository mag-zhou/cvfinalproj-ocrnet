...
#SBATCH --mem=32G
#SBATCH -t 6:00:00
#SBATCH -o logs/train_40pct_%j.out
#SBATCH -e logs/train_40pct_%j.err
...
CONFIG="configs/ocrnet/ocrnet_r50-d8_1xb8-40k_ade20k-512x512-40pct.py"
WORK_DIR="work_dirs/ocrnet_r50_ade20k_40pct"
